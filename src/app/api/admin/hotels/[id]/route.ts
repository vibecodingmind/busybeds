...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  const allowed = ['name', 'city', 'country', 'starRating', 'discountPercent', 'couponValidDays', 'status', 'isFeatured', 'coverImage', 'category', 'descriptionShort', 'descriptionLong', 'websiteUrl', 'email', 'whatsapp', 'address', 'allowBookingRequests'];
