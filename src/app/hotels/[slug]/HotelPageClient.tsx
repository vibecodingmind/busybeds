...
const platformInfo: Record<string, { label: string; bg: string }> = {
  booking_com:  { label: 'Booking.com',  bg: '#003580' },
  airbnb:       { label: 'Airbnb',       bg: '#FF5A5F' },
  expedia:      { label: 'Expedia',      bg: '#00355F' },
  agoda:        { label: 'Agoda',        bg: '#5392CE' },
  tripadvisor:  { label: 'TripAdvisor',  bg: '#00A680' },
};
...
export default function HotelPageClient({ hotel }: { hotel: HotelData }) {
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-3">
                {hotel.affiliateLinks.map(link => {
                  const info = platformInfo[link.platform] || { label: link.platform, bg: '#666' };
                  return (
