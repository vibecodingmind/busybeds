      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 pb-24">
        ...
        <div className="mt-12 bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
          ...
          <div className="prose prose-sm max-w-none text-gray-600 space-y-3">
            <p>
              BusyBeds connects travellers with exclusive hotel discount coupons in {cityName}.
              Browse {hotels.length} verified hotel{hotels.length !== 1 ? 's' : ''} — from budget guesthouses
              to luxury {hotels.some(h => h.starRating >= 5) ? '5-star' : '4-star'} properties — and get
              an instant coupon worth up to {maxDiscount}% off your stay.
            </p>
            <p>
              Unlike traditional booking platforms, BusyBeds coupons are redeemed directly at the hotel —
              no booking fees, no hidden charges. Simply generate your free coupon, present it at check-in,
